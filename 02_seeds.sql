-- INSERT INTO students(name) -- column order matters!
-- VALUES('Warren'); -- VALUES must match the order and number of columns referenced above!

-- INSERT INTO pets(name, breed, type, age, student_id)
-- VALUES('Quorra', 'Akita', 'Dog', 2, 1);
